...
public class CustomRenderer extends PieChartRenderer {
    public CustomRenderer(PieChart chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            for (int j = 0; j < entryCount; j++) {
                ...
                if (entry.getIcon() != null && dataSet.isDrawIconsEnabled()) {
                    ...
                    float x = (labelRadius + iconsOffset.y+100) * sliceXBase + center.x;
                    float y = (labelRadius + iconsOffset.y+100) * sliceYBase + center.y;
                    y += iconsOffset.x;
